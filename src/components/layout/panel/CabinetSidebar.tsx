...
export default function CabinetSidebar() {
    ...
    const menuItems: MenuProps["items"] = [
        ...
        },
        {
            ...
            onClick: () => redirect("/cabinet/robot"),
        },
        {
            key: "/cabinet",
            label: "Баланс",
