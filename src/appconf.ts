...
const dotEnv = {
	...
	jwtUserAccessTokenExpirationMs: ms(
		process.env.JWT_USER_ACCESS_TOKEN_EXPIRATION ?? "0",
	),
	jwtUserRefreshTokenExpirationMs: ms(
		process.env.JWT_USER_REFRESH_TOKEN_EXPIRATION ?? "0",
	),
	jwtServiceAccessTokenExpirationMs: ms(
		process.env.JWT_SERVICE_ACCESS_TOKEN_EXPIRATION ?? "0",
	),
