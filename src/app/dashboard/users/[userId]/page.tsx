...
import AdminDocumentsTab from "@/components/dashboard/tabs/AdminDocumentsTab";
			...
			<Tabs
				...
				items={[
					...
					},
					{
						...
						label: "Стратегии",
						children: (
							<StrategiesTab userId={userId} initialStrategies={strategies} />
						),
					},
					{
						key: "wallets",
					...
					},
					{
						key: "documents",
						label: "Документы",
						children: <AdminDocumentsTab targetUser={user} />,
					},
				]}
			/>
		</PageContent>
