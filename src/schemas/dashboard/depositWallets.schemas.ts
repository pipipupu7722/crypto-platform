...
export const DepositWalletSchema = z.object({
	...
	status: z.nativeEnum(DepositWalletStatus, {
		message: "Выберите статус транзакции",
	}),
	description: z.string().nullable().optional(),
});

export const DepositWalletSchemaRule =
	createSchemaFieldRule(DepositWalletSchema);
