...
class NotificationsService {
	...
	public async sendStrategyClosedNotification(
		payload: EventMap[AppEvents.StrategyClosed],
	): Promise<void> {
		const meta: NotificationMeta[NotificationType.Info] = {
			type: NotificationType.Info,
		};
	...
	public async sendNewStrategyNotification(
		payload: EventMap[AppEvents.NewStrategy],
	): Promise<void> {
